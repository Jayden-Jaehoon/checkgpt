...
OUTPUT_DIR = '/Users/jaehoon/Alphatross/70_Research/checkgpt/rivision/Shannon_Analysis_Claude'
INVESTOR_TYPES = [
    "neutral_investor", 
    "value_investor", 
    "growth_investor",
...
def create_comparison_plots(results_50, results_100):
    ...
    plt.title("Shannon Entropy Comparison: 50 vs 100 Repetitions (Claude)")
    plt.legend()
    ...
    plt.title("Shannon Entropy: 50 vs 100 Repetitions (Claude)")
    plt.grid(True, alpha=0.3)
    plt.tight_layout()
...
def main():
    ...
    if results_50 and results_100:
        print("\nOverall Shannon Entropy Statistics (Collective Method - Claude):")
